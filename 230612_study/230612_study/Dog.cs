...
namespace _230612_study
{
    public class Dog
    {
        ...
        public string dogName = "멍멍이";  //static 이 붙지 않으면 접근 불가 new할때 생긴다 .

        private string dogColor = "하연색";
        private string dogSound = "왈크왈크";

        public void Print_DogDescription001()
        {
        ...
        {
            Console.WriteLine("강아지 이름은 {0} 이고, 색상 {1} 이다.", "모름", "모른다"
               );
